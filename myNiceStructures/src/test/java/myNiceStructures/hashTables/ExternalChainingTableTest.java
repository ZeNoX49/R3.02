 ...
 * @author Rémi Venant
 */
public class ExternalChainingTableTest {

    protected HashTable<String, String> map;

    public ExternalChainingTableTest() {
    }
    ...
    @BeforeEach
    public void setUp() {
        this.map = TestedHashTableImplementationFactory.createExternalChainingTable(10);
    }
    ...
    public void testIterator() {
        Iterator<HashTableEntry<String, String>> it = this.map.iterator();
        ...
        int nbElems = 0;
        while (it.hasNext()) {
            HashTableEntry<String, String> e = it.next();
    ...
    public void testIteratorException() {
        this.map.put("k1", "v1");
        this.map.put("k2", "v2");
        final Iterator<HashTableEntry<String, String>> it = this.map.iterator();
        while (it.hasNext()) {
            it.next();
        }
