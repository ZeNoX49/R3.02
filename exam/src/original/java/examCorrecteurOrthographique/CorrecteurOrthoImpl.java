...
de Hachage `HashMap<String, Boolean>` où les mots sont stockes comme cle et la 
...
public class CorrecteurOrthoImpl implements CorrecteurOrthographique {
    ...
    public boolean ajouterMot(String mot) {
    	// TODO : à implémenter en utilisant ajouterMotRecursif
        throw new UnsupportedOperationException("Méthode à implémenter");
    }
    ...
    public boolean motExiste(String mot) {
        // TODO : à implémenter en utilisant motExisteRecursif
        throw new UnsupportedOperationException("Méthode à implémenter");
    }
    ...
    public boolean retirerMot(String mot) {
        // TODO : à implémenter en utilisant retirerMotRecursif
        throw new UnsupportedOperationException("Méthode à implémenter");
    }
